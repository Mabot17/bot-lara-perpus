                ...
                <div class="card-body">
                    <form id="createForm" action="{{ url('/api/peminjaman/create') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label for="peminjamanKembaliTanggal">Est Tanggal Kembali</label>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="peminjamanTotal" name="peminjaman_total_est_denda" class="form-control"readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
