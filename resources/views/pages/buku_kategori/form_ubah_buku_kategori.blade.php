...
@section('content')
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex flex-wrap align-items-center justify-content-between breadcrumb-content">
                        <h5>Ubah Buku Kategori</h5>
                        <div class="d-flex flex-wrap align-items-center">
                            <a href="{{ route('bukuKategori') }}" class="btn btn-warning"><i class="fe fe-skip-back fe-16 mr-1"></i>Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="col-12 mb-4">
                        <div class="alert alert-success" role="alert">
                            <h4 class="alert-heading">Buku Kategori Berhasil diubah!</h4>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Menggunakan kategoriId dari URL untuk fetch data buku kategori dari API
            fetch(`/api/bukuKategori/detail/${kategoriId}`, {  // Sesuaikan dengan nama parameter yang benar
                method: 'GET',
                headers: {
            ...
            .catch(error => {
                ...
                window.location.href = '/bukuKategori'; // Redirect pada error
            });
        ...
        function submitForm() {
            ...
            fetch("{{ url('/api/bukuKategori/update') }}", {
                method: 'PUT',
                headers: {
                    'Authorization': 'Bearer ' + token,
            ...
            .then(response => {
                if (response.ok) {
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = '/bukuKategori';
