...
<body>
    ...
    <hr>
    <h4 style="text-align: center"><u>Data Kategori Buku</u></h4>
    <table class="nota-info">
        ...
        <tbody>
            @foreach($data_buku_kategori as $buku_kategori)
                <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td>{{ $buku_kategori->kategori_kode }}</td>
                    <td>{{ $buku_kategori->kategori_nama }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
